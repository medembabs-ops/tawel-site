...
function renderLockScreen() {
  ...
  instagramLink.href = 'https://www.instagram.com/tawelstyle?igsh=c3g4NTAxbGh4dnA3&utm_-source=qr';
  instagramLink.target = '_blank';
  instagramLink.rel = 'noopener noreferrer';
  instagramLink.setAttribute('aria-label', 'Tawel Style on Instagram');
  instagramLink.className = 'inline-flex items-center justify-center w-9 h-9 mt-5 rounded text-bordeaux opacity-70 hover:opacity-100 hover:bg-bordeaux/10 focus-visible:opacity-100 focus-visible:bg-bordeaux/10 active:opacity-50 transition-colors';
  instagramLink.innerHTML = `
    <svg class="w-5 h-5" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="1.8" stroke-linecap="round" stroke-linejoin="round" xmlns="http://www.w3.org/2000/svg">
  ...
  content.append(logo, tagline, subheading, cta, instagramLink);
